...
/*四元数取逆（共轭）*/
	...
	static inline Quaternion Quaternion_Enu2Ned( Quaternion quat )
	{
		Quaternion res;
		res.qw = quat.qw;
		res.qx = quat.qy;
		...
		Quaternion r2 = { 0.70710678118654752440084436210485, 0, 0, 0.70710678118654752440084436210485 };
		
		return Quaternion_Mult( res, r2 );
	}